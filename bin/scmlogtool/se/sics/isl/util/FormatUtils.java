 ...
 * Updated : $Date: 2003/07/10 17:58:17 $
 *           $Revision: 1.4 $
 */
...
public class FormatUtils {
  ...
  /**
   * Formats a currency amount as:
   * <em>ddd ddd ddd[.ddd] [M]</em>
   *
  ...
  /**
   * Formats a value with two decimals, using spaces to separate
   * thousands as: <em>ddd ddd ddd.dd</em>.
   *
   * @param value the value to format
   * @return the formatted value as a string
   */
...
//     return "" + i + '.' + (dec < 10 ? "0" : "") + dec;
  ...
  /**
   * Formats a value with two decimals, using the specified separator
   * to separating thousands as:
