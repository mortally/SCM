 ...
 * Updated : $Date: 2004/05/03 07:49:41 $
 *           $Revision: 1.4 $
 *
 * TODO:
...
public class ArgumentManager extends ConfigManager {
  ...
  public void validateArguments() {
	...
	// Argument detected
	a = a.substring(1);
	int index = keyValuesIndexOf(descriptions, PARTS,
				     0, descriptionCount * PARTS,
				     a);
	if (index < 0) {
  ...
  public void usage(int error) {
	...
	if (desc != null && desc.length() > 0) {
	  ...
	  // This should break down long descriptions to several rows
	  // based on columnWidth. FIX THIS!!!
...
//     a.addOption("test", "levelsellerenmassaannatväldigtlångt", "test med lång kommentar");
