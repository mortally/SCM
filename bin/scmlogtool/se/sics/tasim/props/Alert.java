...
/**
 * <code>Alert</code> is used for sending administrative messages to
 * the user behind external agents.  Example of usage is when the
 * agent is using an unsupported communication protocol with the
 * server.  An alert message is then sent with information about the
 * problem before the connection is terminated.
 *
...
public class Alert implements Transportable, java.io.Serializable {
  ...
  public String toString() {
    return getTransportName() + '[' + priority
      + ',' + title + ',' + message + ']';
  }
