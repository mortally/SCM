...
/**
 * <code>ProductionSchedule</code> contains information about
 ...
 * class.
 */
public class ProductionSchedule implements Transportable,
					   java.io.Serializable
{
   ...
   *
   * @param productID the id of the product to be produced
  ...
  public String toString() {
    ...
    for (int i = 0, n = size(); i < n; i++) {
      sb.append('[').append(getProductID(i))
	.append(',').append(getQuantity(i))
	.append(']');
    }
  ...
  public void read(TransportReader reader) throws ParseException {
    while (reader.nextNode("produce", false)) {
      addProduction(reader.getAttributeAsInt("product"),
