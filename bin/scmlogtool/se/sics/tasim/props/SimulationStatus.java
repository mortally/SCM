...
public class SimulationStatus extends SimpleContent {
  ...
  /**
   * Returns the number of milliseconds passed since start of day when
  ...
  public String toString() {
    StringBuffer buf = new StringBuffer()
      .append(getTransportName()).append('[').append(simDate)
      .append(',').append(consumedMillis)
      .append(',').append(isSimulationEnded)
      .append(',');
  ...
  public void write(TransportWriter writer) {
    writer.attr("date", simDate)
      .attr("consumedMillis", consumedMillis);
