...
/**
 * <code>DeliveryNotice</code> contains information about a set of
 * deliveries made between two parts.
 *
...
public class DeliveryNotice implements Transportable, java.io.Serializable {
   ...
   *
   * @param index the index of the delivery in this notice
  ...
  public String toString() {
    ...
    for (int i = 0; i < count; i++) {
      int index = i * PARTS;
      sb.append(',')
	.append('[').append(data[index + ORDER_ID])
	.append(',').append(data[index + PRODUCT_ID])
	.append(',').append(data[index + QUANTITY])
	.append(']');
    }
