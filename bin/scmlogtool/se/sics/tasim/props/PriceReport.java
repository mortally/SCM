...
/**
 * <code>PriceReport</code> contains information about the price
 * interval of ordered products.<p>
 *
...
public class PriceReport implements Transportable, java.io.Serializable {
   ...
   * @return the index of the product or -1 if no informatin about the
   * product was found in this report.
   */
   ...
   *
   * @param index the index of the product information in this report.
  ...
  public void read(TransportReader reader) throws ParseException {
    ...
    while (reader.nextNode("priceInfo", false)) {
      addPriceInfo(reader.getAttributeAsInt(names[PRODUCT_ID]),
		   reader.getAttributeAsInt(names[LOWEST_PRICE]),
		   reader.getAttributeAsInt(names[HIGHEST_PRICE]));
    }
