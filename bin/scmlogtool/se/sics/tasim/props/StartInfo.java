 ...
 * Updated : $Date: 2003/06/13 18:10:53 $
 *           $Revision: 1.12 $
 */
...
/**
 * <code>StartInfo</code> holds information about a game / simulation.
 * It is sent (wrapped in a Message) to all participating agents in
...
public class StartInfo extends SimpleContent {
  ...
  public StartInfo(int simulationID, long startTime, int simulationLength,
    ...
    if (secondsPerDay < 1) {
      throw new IllegalArgumentException("secondsPerDay must be positive: "
					 + secondsPerDay);
    }
  }
  ...
  public String toString() {
    StringBuffer buf = new StringBuffer()
      .append(getTransportName()).append('[').append(simulationID)
      .append(',').append(startTime)
      .append(',').append(simulationLength)
      .append(',').append(secondsPerDay)
      .append(',');
  ...
  public void write(TransportWriter writer) {
    writer.attr("id", simulationID)
      .attr("startTime", startTime)
      .attr("length", simulationLength / 1000)
      .attr("secondsPerDay", secondsPerDay);
    super.write(writer);
  }
