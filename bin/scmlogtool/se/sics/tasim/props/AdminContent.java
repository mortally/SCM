...
/**
 * <code>AdminContent</code> is used for administrative communication
 * with the server.
 *
...
public class AdminContent extends SimpleContent {
  ...
  public static String getErrorAsString(int errorType) {
    return (errorType >= 0 && errorType < ERROR_NAMES.length)
      ? ERROR_NAMES[errorType]
  ...
  public String toString() {
    StringBuffer buf = new StringBuffer()
      .append(getTransportName()).append('[').append(getTypeAsString(type));
    if (isError()) {
