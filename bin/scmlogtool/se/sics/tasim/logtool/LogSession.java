 ...
 * Updated : $Date: 2004/06/13 17:12:27 $
 *           $Revision: 1.3 $
 */
...
public class LogSession implements FileFilter {
  ...
  private static final Logger log =
    Logger.getLogger(LogSession.class.getName());
  ...
  public LogSession(LogManager logManager, String server,
		    ValueSet games, ValueSet excludes) {
    ...
    this.isServerTree = config.getPropertyAsBoolean(CONF + "serverTree", true);
  ...
  private String getFileName(int gameID) {
    StringBuffer path = new StringBuffer().append(gameDirectory)
