 ...
 * Updated : $Date: 2003/07/01 16:41:28 $
 *           $Revision: 1.8 $
 */
package se.sics.tasim.tac03;

/**
 * <code>TAC03Constants</code> defines a number of constants used by
 * TAC03 SCM simulations. The constants are, among other things, used
 * to tag information in the simulation logs files and simulation
 * viewer communication.
 */
public interface TAC03Constants {

  /** The simulation type for TAC03 SCM simulations. */
  public static final String SIMULATION_TYPE = "tac03scm";
  ...
  // -------------------------------------------------------------------
  // The TAC03 SCM participant roles
  // -------------------------------------------------------------------

  /** The TAC03 SCM manufacturer role */
  public static final int MANUFACTURER = 0;
  /** The TAC03 SCM supplier role */
  public static final int SUPPLIER = 1;
  /** The TAC03 SCM customer role */
  public static final int CUSTOMER = 2;
  /** The TAC03 SCM factory role */
  public static final int FACTORY = 3;

  /** The TAC03 SCM participant roles as human readable names. */
