 ...
 * Updated : $Date: 2004/02/12 12:29:14 $
 *           $Revision: 1.1 $
 */
package se.sics.tasim.tac04;

/**
 * <code>TAC04Constants</code> defines a number of constants used by
 * TAC04 SCM simulations. The constants are, among other things, used
 * to tag information in the simulation logs files and simulation
 * viewer communication.
 */
public interface TAC04Constants {

  /** The simulation type for TAC04 SCM simulations. */
  public static final String SIMULATION_TYPE = "tac04scm";
  ...
  // -------------------------------------------------------------------
  // The TAC04 SCM participant roles
  // -------------------------------------------------------------------

  /** The TAC04 SCM manufacturer role */
  public static final int MANUFACTURER = 0;
  /** The TAC04 SCM supplier role */
  public static final int SUPPLIER = 1;
  /** The TAC04 SCM customer role */
  public static final int CUSTOMER = 2;
  /** The TAC04 SCM factory role */
  public static final int FACTORY = 3;

  /** The TAC04 SCM participant roles as human readable names. */
