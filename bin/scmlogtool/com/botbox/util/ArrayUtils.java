/*
 * @(#)ArrayUtils.java	Created date: 99-11-30
 * $Revision: 1.9 $, $Date: 2003/01/21 15:36:18 $
 *
 ...
 * @version $Revision: 1.9 $, $Date: 2003/01/21 15:36:18 $
 */
...
//    }
  ...
  public static int indexOf(Object[] array, int start, int end,
			    Object element) {
    if (element == null) {
  ...
  public static int keyValuesIndexOf(Object[] array, int nth,
				     int start, int end,
				     Object key) {
    if (key == null) {
  ...
  public static int keyValuesIndexOf(int[] array, int nth,
  ...
  public static Object[] add(Object[] array, Object value) {
    Object[] tmp = (Object[])
      java.lang.reflect.Array.newInstance(array.getClass().getComponentType(),
					  array.length + 1);
    System.arraycopy(array, 0, tmp, 0, array.length);
    tmp[array.length] = value;
    return tmp;
  ...
  public static Object[] add(Class componentType,
    ...
    if (array == null) {
      ...
      tmp = (Object[])
	java.lang.reflect.Array.newInstance(componentType, array.length + 1);
      System.arraycopy(array, 0, tmp, 0, array.length);
    }
  ...
  public static Object[] insert(Object[] array, int index, int number) {
    ...
    if (index < array.length) {
      System.arraycopy(array, index, tmp, index + number,
		       array.length - index);
    }
    return tmp;
  }

  public static Object[] insert(Class componentType,
				Object[] array, int index, int number) {
    int len = array == null ? 0 : array.length;
    if ((index < 0) || (index > len)) {
      throw new ArrayIndexOutOfBoundsException(index);
    }
    Object[] tmp = (Object[])
      java.lang.reflect.Array.newInstance(componentType, len + number);
    if (index > 0) {
      System.arraycopy(array, 0, tmp, 0, index);
    }
    if (index < len) {
  ...
  public static Object[] concat(Object[] array1, Object[] array2) {
    ...
    Object[] tmp = (Object[])
      java.lang.reflect.Array.newInstance(array1.getClass().getComponentType(),
  ...
  public static Object[] remove(Object[] array, int index, int number) {
    ...
    if (index + number < array.length) {
      System.arraycopy(array, index + number, tmp, index,
		       array.length - index - number);
    }
    return tmp;
  }
